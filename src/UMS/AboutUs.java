...
public class AboutUs extends JFrame{
	private JPanel contentPane;
        ...
        public AboutUs() {          
            super("About Us - Pune University");
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("UMS/icons/logo.jpg"));
            ...
            contentPane.add(l4);
            JLabel l6 = new JLabel("Developed By : Sanket");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);
            JLabel l7 = new JLabel("MIS Number - 111708031");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);
            JLabel l8 = new JLabel("Contact : kulkarniss17.it@gmail.com");
            ...
            contentPane.add(l9);
            JLabel l10 = new JLabel("Phone - +91 9011811231");
